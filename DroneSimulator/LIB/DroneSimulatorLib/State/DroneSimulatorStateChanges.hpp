...
namespace drone
{
  class DroneSimulatorStateChanges : public boost::static_visitor<boost::optional<std::string>>
  {
  public:
    DroneSimulatorStateChanges(std::shared_ptr<DroneSimulatorStateImpl>& pState);

    boost::optional<std::string> operator()(const messages::BackMessage& message) const;

    boost::optional<std::string> operator()(const messages::BatteryMessage& message) const;

    boost::optional<std::string> operator()(const messages::ClockwiseMessage& message) const;

    boost::optional<std::string> operator()(const messages::CommandMessage& message) const;
    ...
    boost::optional<std::string> operator()(const messages::FlipMessage& message) const;
    ...
    boost::optional<std::string> operator()(const messages::SpeedMessage& message) const;

    boost::optional<std::string> operator()(const messages::TakeoffMessage& message) const;

    boost::optional<std::string> operator()(const messages::TimeMessage& message) const;
